...
if __name__ == "__main__":
    ...
    parser.add_argument("-m", "--model_file", required=True,
                        help="File path to txt file containing paths to models")
    ...
    with open(args.model_file) as f:
        models_list = [i.strip() for i in f.readlines()]
    ...
    for model_path in models_list:
        ...
        for smile_dir in all_smile_dirs:
            ...
            outdir = "{}-{}/{}".format(args.outdir, model_prefix, os.path.basename(smile_dir))
