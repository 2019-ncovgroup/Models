...
from model_ipu import model_fn
...
def main():
    ...
    model_params['batches_per_step'] = 100
    ...
    # IPU requires no remainder; steps must be divisible by batches_per_step
    train_steps += (model_params['batches_per_step'] - train_steps % model_params['batches_per_step'])
    eval_steps -= eval_steps % model_params['batches_per_step']
    ...
    ipu_run_config = ipu.ipu_run_config.IPURunConfig(
        iterations_per_loop=model_params['batches_per_step'],
